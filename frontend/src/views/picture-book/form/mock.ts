  ...
  setup() {
    ...
    Mock.mock(new RegExp('/api/picture-book/[a-zA-Z0-9-]+$'), 'get', () => {
      ...
      return successResponseWrap({
        ...
        physicalPrice: Mock.mock('@float(10,100,2,2)'),
        physicalOriginalPrice: Mock.mock('@float(50,200,2,2)'),
        physicalSpec: Mock.mock('@pick(["A4","A5"])'),
        ...
        digitalOriginalPrice: Mock.mock('@float(20,80,2,2)'),
